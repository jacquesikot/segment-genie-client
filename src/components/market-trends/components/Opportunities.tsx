...
const Opportunities = ({ data }: OpportunitiesProps) => {
  ...
  const sortedOpportunities = [...(data.emergingOpportunities || [])].sort(
    (a, b) => b.potentialImpact - a.potentialImpact
  );
              ...
              {sortedOpportunities.slice(0, 3).map((opportunity, index) => (
                <Card key={index} className="border border-gray-200 dark:border-gray-700 shadow-sm">
                  <CardContent className="p-4">
                    <h3 className="font-medium text-sm mb-2 line-clamp-2">{opportunity.opportunityName}</h3>
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between text-xs mb-1">
                          <span>Impact</span>
                          <span className="font-medium">{opportunity.potentialImpact}/10</span>
                        </div>
                        <Progress
                          value={opportunity.potentialImpact * 10}
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between text-xs mb-1">
                          <span>Barrier</span>
                          <span className="font-medium">{opportunity.barrierToEntry}/10</span>
                        </div>
                        <Progress
                          value={opportunity.barrierToEntry * 10}
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between text-xs mb-1">
                          ...
                          <span className="font-medium">{(opportunity.firstMoverAdvantage * 100).toFixed(0)}%</span>
                        </div>
                        <Progress
